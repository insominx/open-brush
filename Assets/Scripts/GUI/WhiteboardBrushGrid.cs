...
namespace TiltBrush
{
    public class WhiteboardBrushGrid : UIComponent
    {
        // Inspector data

        [SerializeField] private bool m_includeBeginnerMode = true;
        [SerializeField] private bool m_includeAdvancedMode = true;
        [SerializeField] private bool m_includeWhiteboardMode;
        ...
        {
            // mg hack
            m_NumPages = ((BrushCatalog.m_Instance.GuiWhiteboardBrushList.Count - 1) / m_BrushButtons.Length) + 1;
        ...
        void RefreshButtonSelection()
        {
            ...
            for (int i = 0; i < m_BrushButtons.Length; ++i)
            {
                ...
                if (iBrushIndex < BrushCatalog.m_Instance.GuiWhiteboardBrushList.Count)
                {
                    BrushDescriptor rBrush = BrushCatalog.m_Instance.GuiWhiteboardBrushList[iBrushIndex];
        ...
        void RefreshButtonProperties()
        {
            for (int i = 0; i < m_BrushButtons.Length; i++)
            {
                ...
                m_BaseBrushIndex = 0;
                // mg hack
                int numBrushesInBrushList = BrushCatalog.m_Instance.GuiWhiteboardBrushList.Count;
