...
namespace TiltBrush
{
    ...
    public class AlphaPickerSlider : MonoBehaviour
    {
        private int m_Width;
        ...
        void Awake()
        {
            ...
            HSLColor white = new HSLColor(0f, 0f, 1f, 1f);
            ColorPickerUtils.MakeLightnessRamp(white, m_Width, m_Height, m_tempColors);
